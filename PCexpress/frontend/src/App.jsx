...
function App() {
  ...
  const handleAcceleration = (accelerating) => {
  ...
  const theme = createTheme({
    palette: {
      ...
      background: {
        default: 'transparent',
        paper: darkMode ? 'rgba(26, 26, 46, 0.8)' : 'rgba(255, 255, 255, 0.9)',
      },
    },
    components: {
      MuiCard: {
  ...
  return (
    <ThemeProvider theme={theme}>
      <CssBaseline />
      <GlobalBackground isDark={darkMode} isAccelerating={isAccelerating} />
      <LanguageProvider>
        <AuthProvider>
          <Router>
          <Routes>
            {/* Public routes */}
            <Route path="/login" element={<Login darkMode={darkMode} onAcceleration={handleAcceleration} />} />
