...
export default function Products({ darkMode }) {
  ...
  const handleMLAnalysis = (product) => {
    // Store the selected product in localStorage for the Insights component
    localStorage.setItem('selectedProductForML', JSON.stringify(product));
    ...
    return (
      <Box display="flex" flexDirection="column" justifyContent="center" alignItems="center" minHeight="400px">
        ...
        <Typography variant="body1" color="textSecondary">
          Carregando produtos e fornecedores...
        </Typography>
      </Box>
    );
  }
  ...
  return (
    <Box>
          ...
          <Grid container spacing={2} alignItems="center">
            <Grid item xs={12} md={4}>
              <TextField
                ...
                InputProps={{
                  startAdornment: <Search size={20} style={{ marginRight: 8, color: darkMode ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.6)' }} />,
                }}
                sx={{
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&.Mui-focused': {
                      ...
                      border: darkMode ? '1px solid rgba(139, 92, 246, 0.5)' : '1px solid rgba(139, 92, 246, 0.3)',
                    },
                  },
                  '& .MuiInputLabel-root': {
              ...
              <TableBody>
                ...
                <TableCell>
                  <Box display="flex" alignItems="center">
                    <Avatar sx={{ mr: 2, bgcolor: product.em_estoque_baixo ? 'warning.main' : 'success.main' }}>
                      <Package size={20} />
                    </Avatar>
                    <Box>
                      ...
                      {product.descricao && (
                        <Typography variant="body2" sx={{ color: darkMode ? 'rgba(255,255,255,0.7)' : 'rgba(0,0,0,0.6)' }} noWrap>
                          {product.descricao}
                        </Typography>
                      )}
                    </Box>
                ...
                <TableCell sx={{ color: darkMode ? '#ffffff' : '#000000' }}>{product.categoria}</TableCell>
                                 <TableCell>
                   <Box>
                     <Box display="flex" alignItems="center" gap={1}>
                       ...
                       <Typography variant="body2" fontWeight="600" sx={{ minWidth: 30, textAlign: 'center', color: darkMode ? '#ffffff' : '#000000' }}>
                         {product.quantidade}
                       </Typography>
                       <IconButton
                         size="small"
                     ...
                     <LinearProgress
                       ...
                       color={product.quantidade === 0 ? 'error' : product.em_estoque_baixo ? 'warning' : 'success'}
                ...
                <TableCell sx={{ color: darkMode ? '#ffffff' : '#000000' }}>{getSupplierName(product.fornecedor_id)}</TableCell>
                <TableCell>
      ...
      <Dialog open={openDialog} onClose={() => setOpenDialog(false)} maxWidth="md" fullWidth>
        <DialogTitle sx={{ background: 'linear-gradient(45deg, #1976d2, #42a5f5)', color: 'white' }}>
