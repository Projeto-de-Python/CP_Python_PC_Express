...
from app.models import Base, Product, Supplier, User
        ...
        if existing_products == 0:
            ...
            produtos = [
                ...
                Product(
                    ...
                    estoque_minimo=2,
                    fornecedor_id=forn1.id,
                    descricao="AM4, 8c/16t",
                ),
                # Placas-mãe
                Product(
                    user_id=admin_user.id,
                    codigo="MB-001",
                    nome="ASUS Prime B550M",
                    categoria="placa-mae",
                    quantidade=0,
                    preco=799.90,
                    estoque_minimo=2,
                ...
                Product(
                    user_id=admin_user.id,
                    codigo="MB-002",
                    nome="MSI B660M-A WiFi",
                    categoria="placa-mae",
                    quantidade=12,
                    preco=899.90,
                    estoque_minimo=2,
                    fornecedor_id=forn2.id,
                    descricao="LGA1700, mATX",
                ),
                Product(
                    user_id=admin_user.id,
                    codigo="MB-003",
                    nome="Gigabyte X570 Aorus Elite",
                    categoria="placa-mae",
                    quantidade=6,
                    preco=1299.90,
                    estoque_minimo=1,
                ...
                Product(
                    user_id=admin_user.id,
                    codigo="RAM-001",
                    nome="Corsair Vengeance 16GB (2x8) 3200MHz",
                    categoria="memoria",
                    quantidade=13,
                    preco=349.90,
                    estoque_minimo=8,
                ...
                Product(
                    user_id=admin_user.id,
                    codigo="RAM-002",
                    nome="Kingston Fury 32GB (2x16) 3600MHz",
                    categoria="memoria",
                    quantidade=8,
                    preco=699.90,
                    estoque_minimo=4,
                ...
                Product(
                    user_id=admin_user.id,
                    codigo="RAM-003",
                    nome="G.Skill Ripjaws 8GB 2666MHz",
                    categoria="memoria",
                    quantidade=25,
                    preco=199.90,
                    estoque_minimo=10,
                    fornecedor_id=forn3.id,
                    descricao="DDR4, CL19",
                ),
                # Armazenamento
                Product(
                    ...
                    estoque_minimo=5,
                    fornecedor_id=forn2.id,
                    descricao="NVMe, 3500MB/s",
                ),
                Product(
                    user_id=admin_user.id,
                    codigo="SSD-002",
                    nome="SSD SATA 500GB Samsung",
                    categoria="armazenamento",
                    quantidade=18,
                    preco=299.90,
                    estoque_minimo=8,
                    fornecedor_id=forn2.id,
                    descricao="SATA III, 550MB/s",
                ),
                Product(
                    user_id=admin_user.id,
                    codigo="HDD-001",
                    nome="HD 1TB Seagate Barracuda",
                    categoria="armazenamento",
                    quantidade=30,
                    preco=199.90,
                    estoque_minimo=15,
                    fornecedor_id=forn3.id,
                    descricao="7200RPM, SATA III",
                ),
                # Placas de Vídeo
                Product(
                    user_id=admin_user.id,
                    ...
                    estoque_minimo=3,
                    fornecedor_id=forn1.id,
                    descricao="GDDR6, Ray Tracing",
                ),
                Product(
                    user_id=admin_user.id,
                    codigo="GPU-002",
                    nome="AMD RX 6600 8GB",
                    categoria="placa-de-video",
                    quantidade=5,
                    preco=1899.90,
                    estoque_minimo=2,
                ...
                Product(
                    user_id=admin_user.id,
                    codigo="GPU-003",
                    nome="NVIDIA GTX 1660 Super 6GB",
                    categoria="placa-de-video",
                    quantidade=8,
                    preco=1299.90,
                    estoque_minimo=3,
                ...
                Product(
                    ...
                    estoque_minimo=2,
                    fornecedor_id=forn1.id,
                    descricao="Full modular",
                ),
                Product(
                    user_id=admin_user.id,
                    codigo="PSU-003",
                    nome="Fonte 550W 80+ White",
                    categoria="fonte",
                    quantidade=20,
                    preco=199.90,
                    estoque_minimo=8,
                ...
                Product(
                    ...
                    estoque_minimo=2,
                    fornecedor_id=forn1.id,
                    descricao="AIO liquid",
                ),
                # Gabinetes
                Product(
                    user_id=admin_user.id,
                    codigo="CASE-001",
                    nome="Gabinete ATX Mid Tower",
                    categoria="gabinete",
                    quantidade=12,
                    preco=249.90,
                    estoque_minimo=5,
