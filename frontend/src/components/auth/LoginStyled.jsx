...
const LogoIcon = styled(Computer)`
  font-size: 48px;
  color: #667eea;
  filter: ${props => props.theme.mode === 'dark' ? 'drop-shadow(0 0 10px rgba(102, 126, 234, 0.5))' : 'none'};
`;
        ...
        <LoginCard theme={theme}>
          ...
          {error && (
            <Alert 
              ...
              sx={{ 
                mb: 3,
                background: theme.mode === 'dark' ? 'rgba(244, 67, 54, 0.1)' : 'rgba(244, 67, 54, 0.1)',
                border: theme.mode === 'dark' ? '1px solid rgba(244, 67, 54, 0.3)' : '1px solid rgba(244, 67, 54, 0.3)',
              }}
            >
              {error}
            </Alert>
